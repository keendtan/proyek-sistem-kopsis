            ...
            <div class="row g-0 h-100">
                <div class="col-lg-5 kt-auth-panel d-none d-lg-flex flex-column justify-content-between p-5">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="mb-0 fw-bold text-white"><?php echo e(config('app.name')); ?></h5>
                    </div>
                    <div>
                    ...
                    <p class="mb-0 text-white-50 small">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?></p>
                </div>
                <div class="col-lg-7">
...
<?php /**PATH C:\gitrepo\proyek-sistem-kopsis\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
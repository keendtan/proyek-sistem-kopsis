...
<div class="page-content">
    <?php echo $__env->make('include.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <section class="row">
                ...
                <div class="col-6 col-lg-3 col-md-6">
                    <div class="card kt-stat-card h-100">
                        <div class="card-body p-4">
                            ...
                            <h3 class="kt-stat-value mb-0"><?php echo e(count(session('roles'))); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-3 col-md-6">
                ...
                <div class="card-body py-4 px-5">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 name">
                            ...
                            <h6 class="text-muted mb-0">Logged in as <?php echo e(session('active_role')['role']); ?></h6>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\gitrepo\proyek-sistem-kopsis\resources\views/dashboard.blade.php ENDPATH**/ ?>
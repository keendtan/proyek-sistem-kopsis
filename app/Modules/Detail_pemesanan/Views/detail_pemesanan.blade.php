            ...
            <div class="card-body">
                <div class="row align-items-center mb-3 g-2">
                    <div class="col-12 col-md-9">
                        <form action="{{ route('detail_pemesanan.index') }}" method="get">
                    ...
                    <div class="col-12 col-md-3 text-md-end">
						{!! button('detail_pemesanan.create', $title) !!}
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('detail_pemesanan.show','', $item->id) !!}
										{!! button('detail_pemesanan.edit', $title, $item->id) !!}
                                        {!! button('detail_pemesanan.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>

            ...
            <div class="card-body">
                <div class="row align-items-center mb-3 g-2">
                    <div class="col-12 col-md-9">
                        <form action="{{ route('users_kita.index') }}" method="get">
                    ...
                    <div class="col-12 col-md-3 text-md-end">
						{!! button('users_kita.create', $title) !!}
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('users_kita.show','', $item->id) !!}
										{!! button('users_kita.edit', $title, $item->id) !!}
                                        {!! button('users_kita.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>

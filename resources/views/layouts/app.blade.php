            ...
            <div class="sidebar-wrapper active">
				<div class="sidebar-header position-relative">
					<div class="d-flex justify-content-between align-items-center">
						<a href="{{ route('frontend.index') }}" class="d-flex align-items-center text-decoration-none gap-2">
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown me-1">
                                    <a class="nav-link active dropdown-toggle text-gray-700 me-3" href="#"
                                        ...
                                        <span class="badge bg-primary fs-6"> <i class='bi bi-person-lines-fill'></i> {{ get('active_role') }} </span>
                                    </a>
